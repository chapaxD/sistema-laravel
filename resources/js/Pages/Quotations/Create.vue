<template>
  <AuthenticatedLayout title="Nueva Cotización">
    <v-card>
      <v-card-title>
        <div class="d-flex justify-space-between align-center w-100">
          <span class="text-h5">{{ quotation ? 'Editar' : 'Nueva' }} Cotización</span>
...
const clientsWithFullName = computed(() => {
...
const form = useForm({
  id_cliente: props.quotation?.id_cliente || null,
  id_servicio: props.quotation?.id_servicio || null,
